...
from core.const import SERDESER_PATH
from core.context import Context
from core.environment import Environment
from core.logs import logger
from core._roles_init import Role
...
# MGXEnv (upstream's default multi-agent environment) is not vendored;
# we fall back to plain `Environment` regardless of `use_mgx`.
MGXEnv = Environment
