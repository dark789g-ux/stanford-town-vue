...
from core.environment.stanford_town.env_space import (
    EnvAction,
    EnvActionType,
    EnvObsParams,
    EnvObsType,
...
from simulator.actions.dummy_action import DummyAction, DummyMessage
from simulator.actions.inner_voice_action import (
    AgentWhisperThoughtAction,
)
from simulator.actions.run_reflect_action import AgentEventTriple
from simulator.memory.agent_memory import AgentMemory, BasicMemory
from simulator.memory.scratch import Scratch
from simulator.memory.spatial_memory import MemoryTree
from simulator.plan.st_plan import plan
from simulator.reflect.reflect import generate_poig_score, role_reflect
from simulator.utils import llm_logger
from simulator.utils.const import STORAGE_PATH, collision_block_id
from simulator.utils.mg_ga_transform import (
    get_role_environment,
    save_environment,
    save_movement,
)
from simulator.utils.utils import get_embedding, path_finder
from core.logs import logger
from core.role import Role, RoleContext
from core.schema import Message
from core.utils.common import any_to_str
